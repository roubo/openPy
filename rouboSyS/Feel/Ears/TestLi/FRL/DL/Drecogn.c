...
int main(int argc,char **argv)
{
	...
	config = cmd_ln_init(NULL, ps_args(),TRUE,
			...
			/*"-hmm", "/usr/local/share/pocketsphinx/model/hmm/zh/tdt_sc_8k/",
                        ...
                        NULL);*/
			"-hmm", "/usr/local/share/pocketsphinx/model/hmm/en_US/hub4wsj_sc_8k",
                         "-lm",  "/home/roubo/WorkSpace/openPy/rouboSyS/Feel/Ears/TestLi/AC/EarTrain/data/en/testli.lm",
                         "-dict","/home/roubo/WorkSpace/openPy/rouboSyS/Feel/Ears/TestLi/AC/EarTrain/data/en/testli.dic",
                         NULL);
	if(config == NULL)
		return 1;
